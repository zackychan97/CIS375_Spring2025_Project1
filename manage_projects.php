            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    while ($project = mysqli_fetch_assoc($result)){
                        ...
                        echo "<td><a href='edit_project.php?id=" . $project['id'] . "' class='btn btn-sm btn-primary me-1 '>Edit</a>";
                        echo "<a href='delete_project.php?id=" . $project['id'] . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure you want to delete this project?\")'>Delete</a>";                        
                        echo "</tr>";
                    }
                    ?>
                </tbody>
